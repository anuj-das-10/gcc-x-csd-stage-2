...
import { Courses, Navbar, FacultyMemberCard, ImageSlider, SubHeader } from '@/components'
import Image from 'next/image'
import { RankersList } from '@/sections'
...
const about = () => {
  ...
  return (
    ...
    <div className='bg-gradient-to-br from-black via-indigo-950 to-sky-950 h-auto'>
      ...
      <h1 className='text-center text-lg sm:text-3xl text-white font-semibold mt-8'>Department of Computer Science</h1>
      <hr className='mx-64 mt-2 mb-6 border-cyan-600' />
  
      <ImageSlider imagesArray={aboutSliderImages} />
      <p className='max-w-[1024px] text-slate-400 text-justify mt-6 m-auto p-4 font-extralight text-lg'>
...
With its dedication to providing quality education, state-of-the-art facilities, and a track record of producing successful graduates, the Department of Computer Science at Gurucharan College continues to be a pioneer in computer education in the eastern region of India, shaping the future of aspiring computer science professionals.
    ...
    {/* Courses provided by Department of Computer Science */}
          <h2 className='text-white text-3xl font-normal md:font-semibold text-center mt-28'>Courses</h2>
          <hr className='mx-64 mt-2 mb-8 border-gray-600' />
